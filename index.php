...
<body>
    <!-- navbar -->
    <header class="header">
        <a href="./index.php">  <img src="./assets/Images/Logo/Learncharm logo_PNG_Header.png" class="header-logo" alt=""></a>
    ...
    <div class="hero-content">
        ...
        <h3>To LearnCharm</h3>
        <hr>
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nobis praesentium repellendus amet vero, ut debitis et similique explicabo ex quod.Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nobis praesentium repellendus amet vero, ut debitis et similique explicabo ex quod.Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nobis praesentium repellendus amet vero, ut debitis et similique explicabo ex quod.</p>
    ...
    <div class="hero-image">
        <img src="./assets/Images/Hero Section/hero-section.svg" alt="">
    </div>
    </div>
